...
final class Version20190429003353 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE member (id INT AUTO_INCREMENT NOT NULL, status_id INT DEFAULT NULL, local_identifier VARCHAR(255) DEFAULT NULL, external_identifier VARCHAR(255) DEFAULT NULL, first_name VARCHAR(255) DEFAULT NULL, preferred_name VARCHAR(255) DEFAULT NULL, middle_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, join_date DATE DEFAULT NULL, class_year INT DEFAULT NULL, is_deceased TINYINT(1) DEFAULT NULL, employer VARCHAR(255) DEFAULT NULL, primary_email VARCHAR(255) DEFAULT NULL, primary_telephone_number VARCHAR(255) DEFAULT NULL, mailing_address_line1 VARCHAR(255) DEFAULT NULL, mailing_address_line2 VARCHAR(255) DEFAULT NULL, mailing_city VARCHAR(255) DEFAULT NULL, mailing_state VARCHAR(255) DEFAULT NULL, mailing_postal_code VARCHAR(255) DEFAULT NULL, mailing_country VARCHAR(255) DEFAULT NULL, mailing_latitude NUMERIC(10, 8) DEFAULT NULL, mailing_longitude NUMERIC(11, 8) DEFAULT NULL, job_title VARCHAR(255) DEFAULT NULL, occupation VARCHAR(255) DEFAULT NULL, facebook_identifier INT DEFAULT NULL, is_lost TINYINT(1) DEFAULT NULL, is_local_do_not_contact TINYINT(1) DEFAULT NULL, is_external_do_not_contact TINYINT(1) DEFAULT NULL, directory_notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_70E4FA786BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
